...
void HO5500RE_send_pulse_code(int pulsearr[], int len) {
  Serial.println("FAN >> HO5500RE_send_pulse_code");
...
void HO5500RE_send_bin_code(int binarr[], int len, int loops) {
  Serial.println("FAN >> HO5500RE_send_bin_code");
...
void HO5500RE_TEST1() {
  Serial.println("FAN >> HO5500RE_TEST1");
...
void HO5500RE_TEST2() {
  Serial.println("FAN >> HO5500RE_TEST2");
...
void HO5500RE_POWER() {
  Serial.println("FAN >> HO5500RE_POWER");
...
void HO5500RE_SPEED() {
  Serial.println("FAN >> HO5500RE_SPEED");
...
void HO5500RE_MOVEMENT() {
  Serial.println("FAN >> HO5500RE_MOVEMENT");
...
void HO5500RE_TIMER() {
  Serial.println("FAN >> HO5500RE_TIMER");
...
void HO5500RE_SCENE() {
  Serial.println("FAN >> HO5500RE_SCENE");
